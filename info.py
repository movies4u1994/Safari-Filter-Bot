...
BOT_TOKEN = environ.get('BOT_TOKEN', "7833968452:AAHJaqW2zP-IUCrhBZDDXhcerDoSyGLTv3A")
...
premium = environ.get('PREMIUM_LOGS', '-1003007009220')
...
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002696692504'))
...
DATABASE_NAME = environ.get('DATABASE_NAME', "movieforu")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Safaribotts')

#stream link shortner
STREAM_SITE = (environ.get('STREAM_SITE', ''))
STREAM_API = (environ.get('STREAM_API', ''))
STREAM_HTO = (environ.get('STREAMHTO', 'https://t.me/MzMoviiez'))
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movies4uhd2')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MzMoviiez')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1003007009220))
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1003007009220)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1003007009220)) # movies request channel, else log channel
...
# Streaming
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", "-1003007009220")) 
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'loud-robby-moviesforyou-aacbd20f.koyeb.app/'))
